...
RESOURCES += src/qt/bitcorn.qrc src/qt/bitcorn_locale.qrc

TRANSLATIONS += src/qt/locale/bitcorn_bg.ts \
                src/qt/locale/bitcorn_de.ts \
                src/qt/locale/bitcorn_en.ts \
                src/qt/locale/bitcorn_es.ts \
                src/qt/locale/bitcorn_fi.ts \
                src/qt/locale/bitcorn_fr.ts \
                src/qt/locale/bitcorn_it.ts \
                src/qt/locale/bitcorn_ja.ts \
                src/qt/locale/bitcorn_pl.ts \
                src/qt/locale/bitcorn_pt.ts \
                src/qt/locale/bitcorn_ru.ts \
                src/qt/locale/bitcorn_sk.ts \
                src/qt/locale/bitcorn_sv.ts \
