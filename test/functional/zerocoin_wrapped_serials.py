...
from fake_stake.base_test import BITCORN_FakeStakeTest

class zCORNwrappedSerialsTest(BITCORN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCORNs..." % DENOM_TO_USE)
