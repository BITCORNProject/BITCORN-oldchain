...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/BITCORN-Project/BITCORN/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/bitcorn-project/bitcorn/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bitcorn-project/gitian.sigs.git
    git clone https://github.com/bitcorn-project/bitcorn-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/bitcorn-project/bitcorn.git
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in bitcorn, then:
...
### Build and sign BITCORN Core for Linux, Windows, and macOS:

    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit bitcorn=v${VERSION} ../bitcorn/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit bitcorn=v${VERSION} ../bitcorn/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit bitcorn=v${VERSION} ../bitcorn/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. macOS unsigned installer and dist tarball (`bitcorn-${VERSION}-osx-unsigned.dmg`, `bitcorn-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import bitcorn/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the macOS binary:
    ...
    transfer bitcorn-osx-unsigned.tar.gz to macOS for signing
...
- Detached signatures will then be committed to the [bitcorn-detached-sigs](https://github.com/bitcorn-Project/bitcorn-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
bitcorn-${VERSION}-riscv64-linux-gnu.tar.gz
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/BITCORN-Project/BITCORN/releases/new) with a link to the archived release notes.
