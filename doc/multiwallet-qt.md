...
In order to support loading of multiple wallets in bitcorn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcorn.cpp.
...
Changes to bitcorn.cpp
----------------------
bitcorn.cpp is the entry point into bitcorn-qt, and as such, will require some minor modifications to provide hooks for
