...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BITCORN at the same time
...
enum ZerocoinSpendStatus {
    ZBITCORN_SPEND_OKAY = 0,                            // No error
    ZBITCORN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZBITCORN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZBITCORN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZBITCORN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZBITCORN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZBITCORN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZBITCORN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZBITCORN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZBITCORN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZBITCORN_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZBITCORN_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZBITCORN_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZBITCORN_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZBITCORN_SPENT_USED_ZBITCORN = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZBitCornAutoBackups(bool fEnabled)
    {
