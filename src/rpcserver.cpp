...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitCorn features */
        {"bitcorn", "masternode", &masternode, true, true, false},
        {"bitcorn", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcorn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcorn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcorn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcorn", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcorn", "startmasternode", &startmasternode, true, true, false},
        {"bitcorn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcorn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcorn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcorn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcorn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcorn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcorn", "mnbudget", &mnbudget, true, true, false},
        {"bitcorn", "preparebudget", &preparebudget, true, true, false},
        {"bitcorn", "submitbudget", &submitbudget, true, true, false},
        {"bitcorn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcorn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcorn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcorn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcorn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcorn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcorn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcorn", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcorn", "mnsync", &mnsync, true, true, false},
        {"bitcorn", "spork", &spork, true, true, false},
        {"bitcorn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcorn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcornd, or the -server option to bitcorn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
