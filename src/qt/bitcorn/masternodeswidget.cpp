...
#include "qt/bitcorn/masternodeswidget.h"
#include "qt/bitcorn/forms/ui_masternodeswidget.h"
#include "qt/bitcorn/qtutils.h"
#include "qt/bitcorn/mnrow.h"
#include "qt/bitcorn/mninfodialog.h"

#include "qt/bitcorn/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BITCORNGUI *parent) :
    PWidget(parent),
    ui(new Ui::MasterNodesWidget)
{
    ...
    connect(ui->btnAbout, &OptionButton::clicked, [this](){window->openFAQ(3);});
    connect(ui->btnAboutController, &OptionButton::clicked, [this](){window->openFAQ(3);});
}
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:12211 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 10000000)){
            inform(tr("Not enough balance to create a masternode, 1,00,00,000 CORN required."));
            return;
        }
        showHideOp(true);
