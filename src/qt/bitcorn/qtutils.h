...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BITCORNGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BITCORNGUI *gui, double posX = 3);
