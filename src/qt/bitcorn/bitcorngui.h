...
#ifndef BITCORN_CORE_NEW_GUI_BITCORNGUI_H
#define BITCORN_CORE_NEW_GUI_BITCORNGUI_H
...
#include "qt/bitcorn/navmenuwidget.h"
#include "qt/bitcorn/topbar.h"
#include "qt/bitcorn/dashboardwidget.h"
#include "qt/bitcorn/send.h"
#include "qt/bitcorn/receivewidget.h"
#include "qt/bitcorn/addresseswidget.h"
...
*/
class BITCORNGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BITCORNGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BITCORNGUI();
...
#endif //BITCORN_CORE_NEW_GUI_BITCORNGUI_H
