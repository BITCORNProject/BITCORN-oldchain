...
#include "qt/bitcorn/coincontrolcornwidget.h"
#include "qt/bitcorn/forms/ui_coincontrolcornwidget.h"

CoinControlCornWidget::CoinControlCornWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCornWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CORN Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CORN");
    ...
    ui->labelValueAfter->setText("0.00 CORN");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CORN");
    ui->labelValueFee->setText("0.00 CORN");
...
CoinControlCornWidget::~CoinControlCornWidget()
{
    delete ui;
}
