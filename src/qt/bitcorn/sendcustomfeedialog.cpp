...
#include "qt/bitcorn/forms/ui_sendcustomfeedialog.h"
    ...
    ui(new Ui::SendCustomFeeDialog)
{
    ...
    ui->labelMessage->setText(tr("Customize the transaction fee as per your wish, depending on the fee value your transaction will be included or not in the blockchain."));
    ...
    ui->lineEditCustomFee->setPlaceholderText("0.000001 CORN");
