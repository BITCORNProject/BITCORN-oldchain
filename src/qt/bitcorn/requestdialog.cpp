...
#include "qt/bitcorn/requestdialog.h"
#include "qt/bitcorn/forms/ui_requestdialog.h"
#include <QListView>
    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of share a BITCORN address, you can create a Payment Request message which bundles up more information than is contained in just a BITCORN address."));
    ...
    ui->comboBoxCoin->addItem("CORN", 0);
    ...
    QDoubleValidator *doubleValidator = new QDoubleValidator(0, 99999999999, 11, this);
...
void RequestDialog::onNextClicked(){
    if(walletModel) {
        ...
        ui->labelTitle->setText("Request for " + BitcoinUnits::format(displayUnit, value, false, BitcoinUnits::separatorAlways) + " CORN");
