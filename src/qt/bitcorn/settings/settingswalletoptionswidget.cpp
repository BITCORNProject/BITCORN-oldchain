...
#include "qt/bitcorn/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitcorn/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BITCORNGUI* _window, QWidget *parent) :
