...
#include "qt/bitcorn/settings/forms/ui_settingsconsolewidget.h"
...
const struct {
    ...
    const char* source;
        ...
        {"cmd-request", "://ic-transaction-received-inactive"},
        {"cmd-reply", "://ic-transaction-sent-inactive"},
        {"cmd-error", "://ic-transaction-sent-inactive"},
        {"misc", "://ic-transaction-mint-inactive"},
        {NULL, NULL}};
...
#include "qt/bitcorn/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BITCORNGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::changeTheme(bool isLightTheme, QString &theme)
{
    ...
    if (isLightTheme) {
        ui->messagesWidget->document()->setDefaultStyleSheet(
                ...
                "td.message { color: #9b9b9b;font-family: Courier, Courier New, Lucida Console, monospace; font-size: 12px; } " // Todo: Remove fixed font-size
