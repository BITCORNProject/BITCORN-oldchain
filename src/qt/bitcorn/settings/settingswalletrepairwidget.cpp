...
#include "qt/bitcorn/settings/forms/ui_settingswalletrepairwidget.h"
...
SettingsWalletRepairWidget::SettingsWalletRepairWidget(BITCORNGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BITCORNGUI::handleRestart()
