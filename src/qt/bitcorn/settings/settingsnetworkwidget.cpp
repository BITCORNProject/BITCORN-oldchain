...
#include "qt/bitcorn/settings/settingsnetworkwidget.h"
#include "qt/bitcorn/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitcorn/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BITCORNGUI* _window, QWidget *parent) :
