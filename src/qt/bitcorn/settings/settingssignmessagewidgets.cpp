...
#include "qt/bitcorn/settings/settingssignmessagewidgets.h"
#include "qt/bitcorn/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BITCORNGUI* _window, QWidget *parent) :
