...
// Copyright (c) 2015-2018 The BITCORN developers
...
QString formatBalance(CAmount amount, int nDisplayUnit, bool isZcorn){
    return (amount == 0) ? ("0.00 " + BitcoinUnits::name(nDisplayUnit, isZcorn)) : BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, amount, false, BitcoinUnits::separatorAlways, true, isZcorn);
}
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BITCORN address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // Convert bitcorn:// to bitcorn:
    //
    //    Cannot handle this later, because bitcorn:// will cause Qt to see the part after // as host,
