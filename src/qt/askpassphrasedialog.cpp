                                                                                           ...
                                                                                           fCapsLock(false)
{
    ...
    ui->passEdit1->setMaxLength(MAX_PASSBITCORNASE_SIZE);
    ui->passEdit2->setMaxLength(MAX_PASSBITCORNASE_SIZE);
    ui->passEdit3->setMaxLength(MAX_PASSBITCORNASE_SIZE);
...
void AskPassphraseDialog::accept()
{
    ...
    if (!model)
        return;
    oldpass.reserve(MAX_PASSBITCORNASE_SIZE);
    newpass1.reserve(MAX_PASSBITCORNASE_SIZE);
    newpass2.reserve(MAX_PASSBITCORNASE_SIZE);
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BITCORN</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
