...
#include "qt/bitcorn/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR CORN</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                BITCORNGUI* window = static_cast<BITCORNGUI*>(parentWidget());
...
bool AskPassphraseDialog::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn){
    BITCORNGUI* gui = static_cast<BITCORNGUI*>(parentWidget());
...
void AskPassphraseDialog::warningMessage() {
    hide();
    static_cast<BITCORNGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BITCORN will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CORNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
