                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCORNPathCustom = GetArg("-zcornbackuppath", "");
    ...
    if(!strzCORNPathCustom.empty()) {
        ui->wallet_customzcornbackuppath->setText(QString::fromStdString(strzCORNPathCustom));
        ui->wallet_customzcornbackuppath_label->setVisible(true);
        ui->wallet_customzcornbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCORNPathCustom.empty()) && nCustomBackupThreshold > 0) {
