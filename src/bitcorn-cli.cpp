...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("BitCorn Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  bitcorn-cli [options] <command> [params]  " + _("Send command to BitCorn Core") + "\n" +
                        "  bitcorn-cli [options] help                " + _("List commands") + "\n" +
                        "  bitcorn-cli [options] help <command>      " + _("Get help for a command") + "\n";
