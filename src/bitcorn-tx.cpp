...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitCorn Core bitcorn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcorn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcorn transaction") + "\n" +
                               "  bitcorn-tx [options] -create [commands]   " + _("Create hex-encoded bitcorn transaction") + "\n" +
                               "\n";
