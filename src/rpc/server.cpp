...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bitcorn", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcorn", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcorn", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12311/\n";
}
