...
#ifndef BITCORN_ZCORNTRACKER_H
#define BITCORN_ZCORNTRACKER_H
...
public:
    CzCORNTracker(std::string strWalletFile);
    ~CzCORNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCORNWallet* zCORNWallet = NULL);
