...
#ifndef BITCORN_ZCORNWALLET_H
#define BITCORN_ZCORNWALLET_H
...
public:
    CzCORNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCORN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCORN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
