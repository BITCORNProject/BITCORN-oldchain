Contributing to BITCORN
============================

The BITCORN project operates an open contributor model where anyone is
...
The following applies to code changes to the BITCORN project, and is not to be
confused with overall BitCorn Network Protocol consensus changes.

Whether a pull request is merged into BITCORN rests with the project merge
...
Where a patch set proposes to change the BitCorn consensus, it must have been
...
The project leader is the release manager for each BITCORN release.
