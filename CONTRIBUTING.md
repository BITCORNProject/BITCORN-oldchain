...
[Translation Process](https://github.com/bitcorn-project/bitcorn/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITCORN Core project, and is not to be
confused with overall BITCORN Network Protocol consensus changes.

Whether a pull request is merged into BITCORN Core rests with the project merge
...
Patches that change BITCORN consensus rules are considerably more involved than
...
Where a patchset proposes to change the BITCORN consensus, it must have been
...
The project leader is the release manager for each BITCORN Core release.
